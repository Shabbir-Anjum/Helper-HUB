          ...
          <Toolbar className={classes.toolbar}>
              ...
              <div className={classes.messagesWrapper}>
                ...
                <Link to="notifications">
                  <div className={classes.desktopView}>
                    <Typography
                      variant="body1"
                      className={classes.topbarHeading}
                    >
                      Your Messages
                    </Typography>
                  </div>
            ...
            >
              {type === "customer" ? (
                <Avatar
                  src={
                    customer?.pic ? `${url}${customer.pic.url}` : "employee.png"
                  }
                    ...
                    <div key={i} className={classes.category}>
                      ...
                      {val.navs.map((nav, i) => {
                        return (
                          <>
                            {nav.type === undefined ||
                            (nav.type === "customer" && type === "customer") ||
                            (nav.type !== "customer" && type !== "customer") ? (
                              <NavLink
                                key={i}
                                to={nav.link}
...
export default connect(mapStateToProps, { LOGOUT, NEXT_SERVICE })(Index);
