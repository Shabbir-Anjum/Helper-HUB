...
const CompanyInfo = ({NEW_ORDER,FETCH_CLEANER,type,customer,edit,history,employee}) => {
              ...
              <Form>
                <div className={classes.gridWrapper}>
                  ...
                  <div style={{gridArea:"comment"}} className={classes.card}>
                    ...
                    <div className={classes.field}>
                      <Field
                        name="duration" placeholder="duration" as={Input} className={classes.labelInput}
                      />
                      <ErrorMessage component='div' style={{color:"red"}} name="duration" />
                    </div> 
                    <Typography variant='subtitle2'>Duration(hours)</Typography>
                    <div className={classes.field}>
                      <Field
                        name="hour" placeholder="hour" as={Input} className={classes.labelInput}
                      />
                      <ErrorMessage component='div' style={{color:"red"}} name="hour" />
                    </div> 
                    <Typography variant='subtitle2'>Address</Typography>
                    <div className={classes.field}>
                      <Field
                        name="address" placeholder="address" as={Input} className={classes.labelInput}
                      />
                  ...
                  <div style={{gridArea:"type"}} className={classes.card}>
                    <Typography variant='body1' className={classes.cardHeading}>Cleaner Info</Typography>
                    <div className={classes.cleanerWrapper}>
                      <div style={{gridArea:'pic',width:'10vw',height:'10vw',backgroundSize:'cover'}}>
                        <img src={employee?.pic?.url } width='100%'/>
                      </div>
                      ...
                      <Typography variant='body1' style={{gridArea:'available'}} className={classes.infoField}>
                        {employee?.schedule?.available} {" "}
                      </Typography>
