...
import { cleanertype } from '../components/consts';
            ...
            >
              ...
              <Form>
                <div className={classes.headerGrid}>
                  ...
                  <Typography variant='body1' className={clsx(classes.cardHeading,classes.heading2)} style={{gridArea:'emailLable'}}>
                    Type
                  </Typography>
                ...
                <div className={clsx(classes.detailsGrid,classes.card)}>
                  <div style={{gridArea: 'image',marginRight:'1rem',textAlign:'start'}}> 
                    <div className={classes.imgBg}>
                      ...
                      <Typography className={classes.imgBgChip} variant='body2'>Your Pic here</Typography>
                    </div>
                    <Button
                      variant="outlined"
                      component="label"
                  ...
                  <div className={classes.imgBg}>
                  {
                        values.cardId && <img src={URL.createObjectURL(values.cardId)} height='90%' width='90%' alt=''/>
                  }<Typography className={classes.imgBgChip} variant='body2'>Your card here</Typography>
                    </div>
                    <Button
                      variant="outlined"
                      component="label"
                  ...
                  <div style={{gridArea: 'about',justifySelf:'start'}} className={classes.emailWrapper} >
                    <Typography variant='body2' className={classes.label}>
                      Work Experience
                    </Typography>
                    <Field
                      name="about" fullWidth as={Input} className={classes.labelInput}
                    />
                    <ErrorMessage component='div' style={{color:"red"}} name="about" />
                  </div>
                  <div style={{gridArea: 'jobStatus',justifySelf:'start'}} className={classes.emailWrapper} >
                    <Typography variant='body2' className={classes.label}>
                      Job Type
                    </Typography>
                    <Field
                      name="jobStatus" fullWidth as={Input} className={classes.labelInput}
                    />
                    <ErrorMessage component='div' style={{color:"red"}} name="jobStatus" />
                  </div>
